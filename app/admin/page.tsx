  ...
  return (
    ...
    <div className="hero min-h-screen bg-base-200">
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div className='grid gap-4 grid-flow-row grid-cols-3'>
          ...
          <div className='card w-96 bg-base-100 shadow-xl image-full'>
            <figure><Image src='/document.png' alt='documents' width='200' height='200'/></figure>
            {/* <figure><img src='document.png' alt='documents'/></figure> */}
            <div className='card-body card-actions justify-end items-center'><Link className='px-3 btn btn-outline' href='./admin/documents'>Team Documents</Link></div>
          </div>
        </div>
      </div>
  </div>
